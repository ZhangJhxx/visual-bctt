          ...
          <el-form-item label="合约名称">
            ...
            >
              ...
              <el-option
                ...
                :label="contract.data.contractname + ' ( ' + contract.address + ' )'"
                :value="contract.data.contractname"
                @click.native="chooseContract(contract)"
              />
            </el-select>
          </el-form-item>
          <codemirror
          ...
          <el-form-item label="方法">
            ...
            >
              <el-option
                ...
                :label="method"
                :value="method"
                @click.native="chooseMethod(method)"
              />
            </el-select>
          </el-form-item>
